...
function search() {
    ...
    const filtered = colaboradores.filter(colaborador => 
        colaborador.nome.toLowerCase().includes(nameSearch) &&
        colaborador.categoria.toLowerCase().includes(categorySearch) &&
        colaborador.localidade.toLowerCase().includes(locationSearch)
    );
